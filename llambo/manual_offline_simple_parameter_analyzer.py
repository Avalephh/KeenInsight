...
def main():
    ...
    #     # 获取所有函数
    #     data_flow_functions = knob_config['data_flow_functions'][:3]
    #     control_flow_functions = knob_config['control_flow_functions'][:3]
    ...
    knob_name = input("请输入 knob 名称：")

    # result = analyzer.extract_instructions_by_param(knob_name, function_name)

    file_path, line_number = find_function_location(knob_name, "/root/postgresql-analysis/xml") # hzttodo
    print(extract_function_from_file(file_path, line_number))
