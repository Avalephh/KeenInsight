-- Real TPC-C New Order workload concentrated on one warehouse/district.
-- This models an external tenant/site hot spot; no PostgreSQL parameter is
-- changed and all row changes are rolled back after each transaction.
...
VALUES
    (:w_id, :d_id, :o_id, 1, :i1, :w_id, NULL, 1, 1.00, 'TPCC-HOT-DEMO'),
    (:w_id, :d_id, :o_id, 2, :i2, :w_id, NULL, 1, 1.00, 'TPCC-HOT-DEMO'),
    (:w_id, :d_id, :o_id, 3, :i3, :w_id, NULL, 1, 1.00, 'TPCC-HOT-DEMO'),
    (:w_id, :d_id, :o_id, 4, :i4, :w_id, NULL, 1, 1.00, 'TPCC-HOT-DEMO'),
    (:w_id, :d_id, :o_id, 5, :i5, :w_id, NULL, 1, 1.00, 'TPCC-HOT-DEMO');
