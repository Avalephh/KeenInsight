CREATE TEMP TABLE tpcc_temp_pressure AS
...
ANALYZE tpcc_temp_pressure;
SELECT count(*), sum(ol_amount), sum(length(detail_copy)) FROM tpcc_temp_pressure;
SELECT count(*), sum(ol_amount), sum(length(detail_copy)) FROM tpcc_temp_pressure;
SELECT count(*), sum(ol_amount), sum(length(detail_copy)) FROM tpcc_temp_pressure;
SELECT count(*), sum(ol_amount), sum(length(detail_copy)) FROM tpcc_temp_pressure;
SELECT count(*), sum(ol_amount), sum(length(detail_copy)) FROM tpcc_temp_pressure;
SELECT count(*), sum(ol_amount), sum(length(detail_copy)) FROM tpcc_temp_pressure;
DROP TABLE tpcc_temp_pressure;
